...
let modulePaths = {
 ...
 "packages/andrew_bell/config/assets": "packages/andrew_bell/config/assets.ddc",
 "packages/andrew_bell/config/constants": "packages/andrew_bell/config/constants.ddc",
 "packages/andrew_bell/config/projects": "packages/andrew_bell/config/projects.ddc",
 "packages/andrew_bell/config/themes": "packages/andrew_bell/config/themes.ddc",
 "packages/andrew_bell/main": "packages/andrew_bell/main.ddc",
 "packages/andrew_bell/main_web_entrypoint": "packages/andrew_bell/main_web_entrypoint.ddc",
 "packages/andrew_bell/models/project_model": "packages/andrew_bell/models/project_model.ddc",
 "packages/andrew_bell/pages/home_page": "packages/andrew_bell/pages/home_page.ddc",
 "packages/andrew_bell/tabs/about_tab": "packages/andrew_bell/tabs/about_tab.ddc",
 "packages/andrew_bell/tabs/projects_tab": "packages/andrew_bell/tabs/projects_tab.ddc",
 "packages/andrew_bell/tabs/resume_tab": "packages/andrew_bell/tabs/resume_tab.ddc",
 "packages/andrew_bell/widgets/project_widget": "packages/andrew_bell/widgets/project_widget.ddc",
 "packages/andrew_bell/widgets/responsive_widget": "packages/andrew_bell/widgets/responsive_widget.ddc",
 "packages/andrew_bell/widgets/theme_inherited_widget": "packages/andrew_bell/widgets/theme_inherited_widget.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/andrew_bell/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:andrew_bell/main_web_entrypoint.dart") {
          // Clear static caches.
