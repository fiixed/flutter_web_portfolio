define(['dart_sdk', 'packages/flutter/src/widgets/actions', 'packages/flutter/src/rendering/animated_size'], function(dart_sdk, packages__flutter__src__widgets__actions, packages__flutter__src__rendering__animated_size) {
  ...
  dart.defineLazy(CT, {
    ...
    get C0() {
      return C0 = dart.const({
        ...
        [_Location_column]: 12,
        [_Location_line]: 31,
        [_Location_file]: "org-dartlang-app:///packages/andrew_bell/widgets/responsive_widget.dart"
      });
    }
  });
  ...
  dart.setLibraryUri(responsive_widget.ResponsiveWidget, "package:andrew_bell/widgets/responsive_widget.dart");
  ...
  dart.trackLibraries("packages/andrew_bell/widgets/responsive_widget", {
    "package:andrew_bell/widgets/responsive_widget.dart": responsive_widget
  }, {
  }, '{"version":3,"sourceRoot":"","sources":["responsive_widget.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAIe;;;;;;IACA;;;;;;IACA;;;;;;yBAS0B;AACrC,YAAyC,cAAvB,AAAY,AAAK,0BAAd,OAAO,gBAAe;IAC7C;yBAEuC;AACrC,YAAyC,cAAvB,AAAY,AAAK,0BAAd,OAAO,gBAAe;IAC7C;0BAEwC;AACtC,YAAyC,AAAM,cAA7B,AAAY,AAAK,0BAAd,OAAO,gBAAe,OACL,aAAvB,AAAY,AAAK,0BAAd,OAAO,gBAAe;IAC1C;UAG0B;AACxB,YAAO,gDACI,SAAC,SAAS;;AACjB,cAAyB,aAArB,AAAY,WAAD,aAAY;AACzB,kBAAO;gBACF,KAAyB,aAArB,AAAY,WAAD,aAAY,QAA6B,aAArB,AAAY,WAAD,aAAY;AAC/D,iBAAO;gCAAgB;;AAEvB,kBAAO;iCAAe;;;IAI9B;;;QAhCS;QACY;QACV;QACA;;IAFU;IACV;IACA;AACL,sEAAW,GAAG;;EAAC","file":"responsive_widget.ddc.js"}');
  // Exports:
  return {
